<!-- Oficina de Valor adaptation:
  Visual language from Linear (awesome-design-md/linear.app).
  Product UI uses Linear accent (#5e6ad2) on a LIGHT canvas (inverse tokens)
  for governance/finance trust — not Linear marketing near-black.
  Density, hairlines, single accent, measured type: keep.
-->
